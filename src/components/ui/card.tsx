...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-title" className={cn('text-lg font-bold [text-wrap:balance]', className)} {...props} />
}

function CardDescription({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-description" className={cn('text-sm text-black/70 [text-wrap:balance]', className)} {...props} />
}
...
export { Tray, Card, CardHeader, CardFooter, CardTitle, CardAction, CardDescription, CardContent }
